...
if (any(thisData$Question.ID == "{{question_id}}") &&
  ...
  for (i in seq_along(names(multiple_select_table))) {
    ...
    response_labels[[i]] <- responseKey$definition[responseKey$value == val & responseKey$Question.ID == "{{question_id}}" & !is.na(responseKey$Question.ID) & !is.na(responseKey$definition) & !is.na(responseKey$value)]
  }
  ...
  response_key_subset <- responseKey[(responseKey$Question.ID == "{{question_id}}" & responseKey$type == "Response"), ]
